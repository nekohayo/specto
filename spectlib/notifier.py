...
### Watch functions ###
    ...
    def clear_watch(self, widget, *id):
        ...
        if type == 0:#website
            ...
            try: icon = self.specto.icon_theme.load_icon("internet-news-reader", 22, 0) #if the theme (ex.: gnome) does not have the icon
            except: icon = self.specto.icon_theme.load_icon("applications-internet", 22, 0)
